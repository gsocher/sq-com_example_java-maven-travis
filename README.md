...
[![Build status](https://travis-ci.org/SonarSource/sq-com_example_java-maven-travis.svg?branch=master)](https://travis-ci.org/SonarSource/sq-com_example_java-maven-travis) [![Quality Gate](https://sonarcloud.io/api/project_badges/quality_gate?project=com.sonarqube.examples:java-maven-travis-project)](https://sonarcloud.io/api/project_badges/quality_gate?project=com.sonarqube.examples:java-maven-travis-project)
